...
import "@/styles/view-style/table.scss";
      ...
      selections: [
        {
          ...
          onSelect: () => {
            this.setState({
              selectedRowKeys: new Array(46).fill(0).map((a, i) => i), // 0...45
            });
          },
        },
        {
...
class Table4 extends Component {
  ...
  render() {
    let sortedInfo: any = this.state.sortedInfo || {};
    let filteredInfo: any = this.state.filteredInfo || {};
    const columns: ColumnsType<any> = [
      ...
      },
      {
        ...
        filters: [
          {
            text: "London, Park Lane no. 24",
            value: "London, Park Lane no. 24",
          },
          {
            text: "London, Park Lane no. 27",
            value: "London, Park Lane no. 27",
          },
        ],
